...
function ForecastHourly({ latt, longi, currentWeather, selectedDay, rain }) {
  ...
  return (
    <div
      className={` ${
        rain ? "bg-[#ACA0B766]" : "bg-[#DEAB4D]"
      } flex flex-col items-center lg:block h-[295px] lg:h-[262px] mx-6 lg:mx-0 rounded-[15px] lg:rounded-[40px]`}
    >
      ...
      <div
        className={`${
          rain ? "bg-[#FFAA0F]" : "bg-[#EACA8F]"
        } text-center text-sm rounded-full w-[225px] py-2 lg:hidden`}
      >
        5-day forecast
      </div>
    </div>
